					...
					<div class="collapse navbar-collapse offset"
						...
						<ul class="nav navbar-nav menu_nav ml-auto">
							...
							<c:choose>
								...
								<c:otherwise>
									<li class="nav-item active"><a href="dangnhapController"
			...
			<div
				...
				<div class="col-first">
					...
					<nav class="d-flex align-items-center">
						<a href="trangchuController">Home<span
							class="lnr lnr-arrow-right"></span></a> <a
							href="doithongtinController">Change information</a>
					</nav>
				</div>
			</div>
		</div>
			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="login_form_inner">
						...
						<form class="row login_form" action="doithongtinController"
							method="post" id="contactForm" novalidate="novalidate">
							<div class="col-md-12 form-group">
								<small class="d-flex">Name</small> <input type="text"
									class="form-control" name="hoten" value="${dn.getHoten() }"
									placeholder="Name" onfocus="this.placeholder = ''"
									onblur="this.placeholder = 'Name'" required="required">
							</div>
							<div class="col-md-12 form-group">
								<small class="d-flex">Address</small> <input type="text"
									class="form-control" name="diachi" value="${dn.getDiachi() }"
									placeholder="Address" onfocus="this.placeholder = ''"
									onblur="this.placeholder = 'Address'" required="required">
							</div>
							<div class="col-md-12 form-group">
								<small class="d-flex">Phone</small> <input type="text"
									class="form-control" name="sodt" value="${dn.getSodt() }"
									placeholder="Phone" onfocus="this.placeholder = ''"
									onblur="this.placeholder = 'Phone'" required="required">
							</div>
							<div class="col-md-12 form-group">
								<small class="d-flex">Email</small> <input type="email"
									class="form-control" name="email" value="${dn.getEmail() }"
									placeholder="Email" onfocus="this.placeholder = ''"
									onblur="this.placeholder = 'Email'" required="required">
							</div>
							<div class="col-md-12 form-group">
								<button type="submit" value="submit" name="th"
									class="primary-btn">Change</button>
							</div>
						</form>
					</div>
				</div>
