			...
			<div class="main-content-inner">
				<div class="row">
					...
					<div class="col-12 mt-5">
						<div class="card">
							<div class="card-body">
								<h4 class="header-title">Manager Categories</h4>

								<div class="container" style="margin: 20px;">
									<!-- 									<div class="row" style="display: flex; justify-content: center;">
										<div class="col-sm-4"> -->
									<form action="adminquanlyloaiController" method="post"
										class="form-inline" style="gap: 30px;">

										<label for="txtml">Category ID:</label> <input type="text"
											class="form-control" id="txtml" name="txtml"> <label
											for="txttl">Name:</label> <input type="text"
											class="form-control" id="txttl" name="txttl"> <input
											type="submit" name="btnAdd" value="Add" class="btn btn-primary">
										...
										<tbody>
											<c:forEach var="l" items="${dsloai }">
												<tr>
													<td>${l.getMaloai() }</td>
													<td>${l.getTenloai() }</td>
													<td><a href="adminquanlyloaiController"><span
															class="ti-settings text-dark mr-3"></span></a> <a
														href="adminquanlyloaiController"><span
