			...
			<div class="main-content-inner">
				<div class="row">
					...
					<div class="col-12 mt-5">
						<div class="card">
							<div class="card-body">
								<h4 class="header-title">Bill - ${mahd }</h4>
								<div class="data-tables">
									<table id="dataTable" class="text-center">
										...
										<tbody>
											<c:forEach var="cthd" items="${dscthd }">
												<tr>
													<td>${cthd.getTengiay() }</td>
													<td>${cthd.getSize() }</td>
													<td>$${cthd.getGia() }</td>
													<td>x ${cthd.getSoluongmua() }</td>
													<td>$${cthd.getThanhtien() }</td>
													<td><a
														href="adminxacnhanchitiethoadonController?mahd=${cthd.getMahd() }&macthd=${cthd.getMacthd() }"><span
