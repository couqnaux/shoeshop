				...
				<div class="col-first">
					...
					<nav class="d-flex align-items-center">
						<a href="trangchuController">Home<span
							class="lnr lnr-arrow-right"></span></a> <a href="category.html">Purchase
							history</a>
					</nav>
				</div>
			</div>
			...
			<div class="order_details_table">
				...
				<div class="table-responsive">
					<table class="table">
						...
						<tbody>
							<c:forEach items="${dshdChuaMua }" var="i">
								<tr>
									<td>
										<p>${i.getMahd() }</p>
									</td>
									...
									<td><a href="lichsumuahangController?mahd=${i.getMahd() }">👁️</a></td>
								</tr>
							</c:forEach>
						</tbody>
					</table>
			...
			<div class="order_details_table">
				...
				<div class="table-responsive">
					<table class="table">
						...
						<tbody>
							<c:forEach items="${dshdDaMua }" var="i">
								<tr>
									<td>
										<p>${i.getMahd() }</p>
									</td>
