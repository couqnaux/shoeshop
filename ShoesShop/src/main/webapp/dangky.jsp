					...
					<div class="login_form_inner">
						...
						<c:if test="${mess !=null }">
							<div class="alert alert-danger"
								...
								<strong>Failed! </strong> ${mess }
							</div>
						</c:if>
						<form class="row login_form" action="dangkyController"
							method="post" id="contactForm" novalidate="novalidate">
							<div class="col-xs-6 col-md-12 form-group">
								<input type="text" class="form-control" name="txtht"
									placeholder="Fullname" onfocus="this.placeholder = ''"
									onblur="this.placeholder = 'Fullname'" required="required">
							</div>
							<div class="col-xs-6 col-md-12 form-group">
							...
							<div class="col-xs-6 col-md-12 form-group">
								<input type="email" class="form-control" name="txtem"
							...
							<div class="col-xs-6 col-md-12 form-group">
								<input type="password" class="form-control" name="txtrepass"
									...
									onblur="this.placeholder = 'Confirm password'" required="required">
							</div>
							<div class="col-md-12 form-group">
								<button type="submit" value="submit" name="th"
									class="primary-btn">Sign Up</button>
								<a href="dangnhapController">Have an account?</a>
							</div>
						</form>
					</div>
				</div>
