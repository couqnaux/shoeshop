				...
				<div class="col-first">
					...
					<nav class="d-flex align-items-center">
						<a href="trangchuController">Home<span
							...
							href="doimatkhauController">Change password</a>
					</nav>
				</div>
			</div>
		</div>
			...
			<div class="row">
				...
				<div class="col-lg-6">
					<div class="login_form_inner">
						...
						<form class="row login_form" action="doimatkhauController"
							...
							<div class="col-md-12 form-group">
								<input type="password" class="form-control" name="mkmoi"
									...
									onblur="this.placeholder = 'New password'" required="required">
							</div>
							<div class="col-md-12 form-group">
								<input type="password" class="form-control" name="remkmoi"
