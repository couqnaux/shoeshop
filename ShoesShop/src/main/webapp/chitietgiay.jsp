			...
			<div class="row s_product_inner">
				<div class="col-lg-6">
					<div class="s_Product_carousel">
						<div class="single-prd-item">
							<img class="img-fluid" src="${giay.getAnh() }"
								alt="${giay.getTengiay() }" style="background: #828bb3">
						</div>
						<div class="single-prd-item">
							<img class="img-fluid" src="${giay.getAnh() }"
								alt="${giay.getTengiay() }" style="background: #828bb3">
				...
				<div class="col-lg-5 offset-lg-1">
					<div class="s_product_text">
						<h3>${giay.getTengiay() }</h3>
						<h2>$${giay.getGia() }</h2>
						<ul class="list">
							<li><a class="active text-capitalize" href="#"><span>Category</span>
									: ${giay.getMaloai() }</a></li>
						...
						<!-- <div class="product_count">
							<label for="qty">Quantity:</label> <input type="text" name="qty"
								id="sst" maxlength="12" title="Quantity:" class="input-text qty">
							<button
						...
						<%-- <div class="product_count d-flex">
							<label for="qty" style="margin-right: 30px;">Size:</label> <select
								name="size" class="size-select">
								<c:forEach items="${dsSize }" var="s">
						...
						<div class="card_area d-flex align-items-center">
							<a class="primary-btn"
								href="giohangController?mg=${giay.getMagiay() }
								&anh=${giay.getAnh() }
								&tg=${giay.getTengiay() }
								&size=${size }
								&gia=${giay.getGia() }
						...
						<!-- 	&anh=${giay.getAnh() }
								&tg=${giay.getTengiay() }
								&gia=${giay.getGia() } -->
						<form action="giohangController?mg=${giay.getMagiay() }"
							method="post">
							<!-- <input type="text" name="txtsl" class="input-text qty"> -->
							<div class="product_count">
								<label for="qty">Quantity:</label> <input type="number"
									name="txtsl" id="sst" maxlength="12" title="Quantity:"
									class="input-text qty" value="1" required="required"
									style="color: #777777;">
							</div>
							<div class="product_count d-flex">
								<label for="qty" style="margin-right: 30px;">Size:</label> <select
									name="txtsize" class="size-select">
									<c:forEach items="${dsSize }" var="s">
										<option value="${s }">${s }</option>
									</c:forEach>
								</select>
							</div>
							<div class="card_area d-flex align-items-center border-0">
								<button type="submit" name="th"
									class="primary-btn border border-0">Add to Cart</button>
							</div>
						</form>
					</div>
				</div>
