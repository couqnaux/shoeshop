			...
			<div class="row fullscreen align-items-center justify-content-start">
				<div class="col-lg-12">
					<div class="active-banner-slider owl-carousel">
						<c:forEach items="${dsslide }" var="i">
							<!-- single-slide -->
							<div class="row single-slide align-items-center d-flex">
								<div class="col-lg-5 col-md-6">
									<div class="banner-content">
										<h1>
											<span class="text-capitalize">${i.getMaloai() }</span> New <br>Collection!
										</h1>
										<p>${i.getMota() }</p>
								...
								<div class="col-lg-7">
									<div class="banner-img">
										<img class="img-fluid" src="${i.getAnh() }"
											alt="${i.getTengiay() }">
									</div>
								</div>
							</div>
	...
	<section class="owl-carousel active-product-area section_gap">
		...
		<div class="single-product-slider">
			<div class="container">
				...
				<div class="row">
					<c:forEach items="${dslatest }" var="i">
						<!-- single product -->
						<div class="col-lg-3 col-md-6">
							<div class="single-product">
								...
								<div class="product-details">
									...
									<div class="price">
										<h6>$${i.getGia() }</h6>
										<h6 class="l-through">$${i.getGia() +50 }</h6>
									</div>
		...
		<div class="container">
			<div class="row">
				<a class="col single-img" href="#"> <img
					class="img-fluid d-block mx-auto" src="img/brand/1.png" alt="">
				</a> <a class="col single-img" href="#"> <img
					class="img-fluid d-block mx-auto" src="img/brand/2.png" alt="">
				</a> <a class="col single-img" href="#"> <img
					class="img-fluid d-block mx-auto" src="img/brand/3.png" alt="">
				</a> <a class="col single-img" href="#"> <img
					class="img-fluid d-block mx-auto" src="img/brand/4.png" alt="">
				</a> <a class="col single-img" href="#"> <img
					class="img-fluid d-block mx-auto" src="img/brand/5.png" alt="">
				</a>
			</div>
		</div>
	</section>
